...
/// RFC2445 Section 4.8.1.5
class DescriptionProperty extends CalendarProperty<TextValue> {
  ...
  factory DescriptionProperty.fromCrawledProperty(CrawledProperty property) {
    assert(
      property.name.toUpperCase() == "DESCRIPTION",
